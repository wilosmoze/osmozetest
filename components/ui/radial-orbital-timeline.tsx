...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full min-h-[100dvh] flex flex-col items-center justify-center bg-bg overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-accent via-orange-600 to-red-700 animate-pulse flex items-center justify-center z-10">
