...
export const menu: MenuItem[] = [
  ...
  },
  {
    ...
    name: "Deep Groove",
    description: {
      en: "Deep and savoury. Double Charolais steak, Grana Padano, orange cheddar, red mayo, green salad, tomato and onions.",
      fr: "Profond et savoureux. Double steak charolais, Grana Padano, cheddar orange, mayo rouge, salade verte, tomate et oignons.",
      ru: "Глубокий и насыщенный. Двойной стейк шароле, Грана Падано, оранжевый чеддер, красный майонез, зелёный салат, помидор и лук.",
      th: "เข้มข้นและมีรสอูมามิ เนื้อชาโรเลส์คู่ กราน่า ปาดาโน่ ชีสเชดดาร์ส้ม มายองเนสแดง สลัดผัก มะเขือเทศ และหอมใหญ่",
    },
    price: 299,
    menuPrice: 399,
