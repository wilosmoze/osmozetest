...
export const menu: MenuItem[] = [
  ...
  },
  {
    ...
    name: "Deep Groove",
    description: {
      en: "Deep and savoury. Double Charolais steak, Grana Padano, orange cheddar, fried egg, red mayo, green salad, tomato and onions.",
      fr: "Profond et savoureux. Double steak charolais, Grana Padano, cheddar orange, œuf au plat, mayo rouge, salade verte, tomate et oignons.",
      ru: "Глубокий и насыщенный. Двойной стейк шароле, Грана Падано, оранжевый чеддер, яичница-глазунья, красный майонез, зелёный салат, помидор и лук.",
      th: "เข้มข้นและมีรสอูมามิ เนื้อชาโรเลส์คู่ กราน่า ปาดาโน่ ชีสเชดดาร์ส้ม ไข่ดาว มายองเนสแดง สลัดผัก มะเขือเทศ และหอมใหญ่",
    },
    price: 299,
    menuPrice: 399,
  ...
  },
  {
    ...
    name: "Soul",
    description: {
      en: "Rich and soulful. Double Charolais steak, emmental, orange cheddar, crispy bacon, caramelized onions, green salad, mustard & ketchup.",
      fr: "Riche et soulful. Double steak charolais, emmental, cheddar orange, bacon croustillant, oignons caramélisés, salade verte, moutarde & ketchup.",
      ru: "Богатый и душевный. Двойной стейк шароле, эмменталь, оранжевый чеддер, хрустящий бекон, карамелизованный лук, зелёный салат, горчица и кетчуп.",
      th: "เข้มข้นและมีจิตวิญญาณ เนื้อชาโรเลส์คู่ ชีสเอมเมนทาล ชีสเชดดาร์ส้ม เบคอนกรอบ หอมใหญ่คาราเมล สลัดผัก มัสตาร์ดและซอสมะเขือเทศ",
    },
    price: 309,
    menuPrice: 409,
